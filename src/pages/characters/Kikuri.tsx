...
const Hiroi = ({ onBack }: HiroiProps) => {
      ...
      content: (
        <div className="space-y-2.5 text-xs leading-relaxed text-black font-mono">
          <p className="font-semibold">
            Hic... Oh, hey there! I’m Kikuri Hiroi, the bassist and vocalist of <span className="bg-[#a855f7] text-white px-1 font-bold">SICK HACK!</span>
          </p>
          <p className="text-black/80">
            I’m basically a wandering indie musician who loves her canned sake a bit too much. I met little Bocchi-chan at a park and sort of took her under my wing. When I’m on stage playing psychedelic rock, my whole world transforms! Wanna grab a drink after the show?
          </p>
        </div>
      ),
      photo: 'img/kikkuri/aboutme.jpg',
      caption: 'SICK HACK BASSIST',
      seat: '05H',
    },
    {
      id: 'funfact',
      ...
      content: (
        <ul className="space-y-2 text-xs font-mono text-black list-disc list-inside">
          <li>Constantly broke because she spends all her money on alcohol and musical gear.</li>
          <li>A legendary drunk who plays incredible psychedelic rock bass live.</li>
          <li>Mentors Hitori (Bocchi) on how to handle live house crowds and stage performance.</li>
          <li>Rides around on a bass guitar case strapped to her back like a true rockstar.</li>
        </ul>
      ),
      photo: 'img/kikkuri/funfact.jpg',
      caption: 'SAKE LOVER',
      seat: '05K',
    },
    {
      ...
      content: (
        <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-black">
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">MAIN BASS</p>
            <p className="text-black/70">Edwards E-JB (Modified)</p>
          </div>
          <div className="bg-[#121212]/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">DRINK OF CHOICE</p>
            <p className="text-black/70">Onikoroshi Canned Sake</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">BAND STYLE</p>
            <p className="text-black/70">Psychedelic Rock</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">VENUE</p>
            <p className="text-black/70">Indie Live Houses</p>
          </div>
        </div>
      ),
      photo: 'img/kikkuri/gear.jpg',
      caption: 'STAGE RIG',
      seat: '05S',
    },
    {
      ...
      content: (
        <div className="space-y-2 text-xs font-mono text-black">
          <p className="text-[10px] text-black/60 font-bold uppercase">// SICK HACK INQUIRIES & BAR TAB</p>
          <div className="space-y-1.5 border-l-2 border-[#a855f7] pl-3">
            <div>
              <span className="font-bold uppercase text-black/50 text-[9px] block">LOCATION</span>
              <span className="text-black font-bold">Local Izakaya / Tokyo, JP</span>
            </div>
            <div>
              <span className="font-bold uppercase text-black/50 text-[9px] block">AFFILIATION</span>
              <span className="text-black font-bold">SICK HACK Band</span>
            </div>
          </div>
        </div>
      ),
      photo: 'img/kikkuri/contactme.jpg',
      caption: 'INDIE LIVEHOUSE',
      seat: '05X',
    },
  ];
  ...
  const hiroiImgSrc = 'img/kikkuri/photocard.png';
    ...
    >
            ...
            >
              <h1 className="text-7xl font-black tracking-tighter uppercase leading-none flex gap-2 whitespace-nowrap">
                {wordRepeats.map((_, wordIdx) => {
                  const isPurple = (colIdx + wordIdx) % 2 === 0;
                  const word = (wordIdx + (isOddCol ? 1 : 0)) % 2 === 0 ? 'SICK' : 'HACK';
                  return (
                    <span key={wordIdx} className={isPurple ? 'text-[#9333ea]' : 'text-[#808080]'}>
                      {word}
                    </span>
                  );
                })}
      ...
      <div className="absolute inset-0 pointer-events-none z-50 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(105deg, transparent 30%, rgba(233,213,255,0.45) 42%, rgba(250,245,255,0.85) 50%, rgba(233,213,255,0.45) 58%, transparent 70%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(250,245,255,0.8) 0%, rgba(233,213,255,0.3) 40%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
      </div>
      ...
      <div className="relative z-60 h-full flex flex-col justify-between p-8 text-white font-medium text-sm tracking-tight pointer-events-none">
        ...
        <div className="w-full flex justify-between items-end">
          <div className="leading-tight">
            <p className="font-bold">Wanna drink</p>
            <p>some sake?!!</p>
          </div>
          <button
            onClick={onBack}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#a855f7] text-white font-mono font-bold text-xs border-2 border-white shadow-[3px_3px_0px_#fff] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_#fff] transition-all cursor-pointer uppercase pointer-events-auto"
          >
            <ArrowLeft className="w-4 h-4" /> BACK
          </button>
          <div className="text-right leading-tight">
            <p className="font-bold">let's join</p>
            <p>the livehouse</p>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="w-[375px] pr-5 flex flex-col justify-between relative z-10">
                  <div>
                    <div className="flex justify-between items-start border-b-2 border-black pb-2 mb-3">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="bg-[#a855f7] text-white text-[9px] font-black px-1.5 py-0.5 uppercase tracking-wider">
                          PASS NO. 0{idx + 1}
                        </span>
                  ...
                  <div className="pt-2 border-t border-dashed border-black/40 flex justify-between items-end text-[8px] text-black/60 font-bold uppercase">
                    <div>
                      <p className="text-black/50">INDIE LIVE / TOKYO 2026</p>
                      <p className="text-[10px] text-black font-extrabold leading-tight">SICK HACK TOUR</p>
                    </div>
                    ...
                    <div className="w-16 h-5 overflow-hidden opacity-80">
                      <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                        <pattern id={`fine-barcode-hiroi-${idx}`} width="100%" height="10" patternUnits="userSpaceOnUse">
                        ...
                        <rect width="100%" height="100%" fill={`url(#fine-barcode-hiroi-${idx})`} />
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="w-full flex justify-center mt-0.5">
                    <div className="relative border-2 border-black rounded-full px-2 py-0.5 -rotate-6 flex items-center justify-center bg-white shadow-xs">
                      <span className="font-extrabold text-[10px] tracking-tighter text-black">シックハック</span>
                  ...
                  <div className="w-full h-[200px] bg-white border-2 border-black p-1 flex flex-col justify-between shadow-xs">
                    ...
                    <div className="text-center pt-0.5">
                      ...
                      <p className="text-[7.5px] font-extrabold text-[#9333ea] tracking-widest mt-0.5">
                        KIKURI HIROI
                      </p>
                    </div>
                  </div>
      ...
      <div className="absolute top-100 left-100 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[650px]">
        <div className="absolute -inset-40 pointer-events-none z-50 mix-blend-screen opacity-40">
          {Array.from({ length: 14 }).map((_, i) => {
            ...
            return (
              <div
                key={i}
                className="absolute rounded-full bg-[#F3E8FF]"
          ...
          >
            <div className="flex flex-col justify-between items-start border-t pt-2 border-black/20 w-full">
              <div className="text-[9px] font-bold tracking-tighter">
                ...
                <p className="text-[11px]">KIKURI HIROI</p>
              </div>
              <div className="text-[9px] font-bold tracking-tighter">
              ...
              <div className="w-8 h-24 bg-transparent overflow-hidden">
                <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                  <pattern id="fine-barcode-horizontal-hiroi" width="100%" height="8" patternUnits="userSpaceOnUse">
                  ...
                  <rect width="100%" height="100%" fill="url(#fine-barcode-horizontal-hiroi)" />
                </svg>
              </div>
            </div>
        ...
        {/* 3. Photocard */}
        <Photocard imgSrc={hiroiImgSrc} photoScale={1.3} />
        ...
        >
          ...
          <div className="w-[325px] p-5 flex items-stretch justify-between relative z-10">
            <div className="relative border-[4px] border-black p-2 pr-3 flex flex-col justify-between w-[185px] bg-[#fff] shadow-xs">
              <span
                className="absolute top-7 left-1 text-[#a855f7] font-black text-xl tracking-tighter z-20 -rotate-6 whitespace-nowrap"
                style={{
                  textShadow:
              ...
              <div className="flex items-center gap-1 mt-1">
                ...
                <span className="text-[10px] font-black tracking-widest uppercase">INDIE LIVE</span>
          ...
          <div className="w-[175px] p-4 flex flex-col justify-between items-end relative z-10 pl-6">
            <div className="w-full flex justify-center mt-1">
              <div className="relative border-2 border-black rounded-full px-2 py-0.5 -rotate-12 flex items-center justify-center">
                <span className="font-extrabold text-[11px] tracking-tighter text-black">シックハック</span>
                <div className="absolute inset-0 border border-black rounded-full scale-105 rotate-6 pointer-events-none" />
              </div>
            </div>
