      ...
      content: (
        <div className="space-y-2.5 text-xs leading-relaxed text-black font-mono">
          <p className="font-semibold">
            Hi! I’m Kita Ikuyo—though I’d really, really prefer it if you just call me <span className="bg-[#C82329] text-white px-1">Kita-san!</span>.
          </p>
          <p className="text-black/80">
            I’m a first-year student at Shuuka High School, and I’m super proud to be the vocalist and rhythm guitarist for Kessoku Band! Honestly, my journey starting out was a bit embarrassing... I actually joined the band at first without knowing how to play the guitar at all, and I even ran away out of panic! But thanks to Hitori-chan (Goti-chan) teaching me with so much patience, I fell in love with playing and decided to give it everything I’ve got.
          </p>
        </div>
      ),
      photo: 'img/kita/about.jpg',
    ...
    },
    {
      ...
      content: (
        <ul className="space-y-2 text-xs font-mono text-black list-disc list-inside">
          <li>Gets super embarrassed by her name "Ikuyo" because it sounds like "Let's go!".</li>
          <li>Mistakenly bought a 6-string bass thinking it was an electric guitar.</li>
          <li>Plays a red Gibson Les Paul Junior Special bought from Ryo-senpai.</li>
          <li>Emits a blinding extrovert energy known by everyone as the "Kita-Aura".</li>
          <li>Loves taking cute Issta photos and managing Kessoku Band's social vibe.</li>
        </ul>
      ),
      photo: 'img/kita/funfact.jpg',
      caption: 'KITA-AURAN',
      seat: '02B',
    },
    {
      ...
      content: (
        <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-black">
          <div className="bg-black/5 p-2 border border-black/25">
            ...
            <p className="text-black/70">Gibson Les Paul Jr Special</p>
          </div>
          <div className="bg-[#121212]/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">VOCAL MIC</p>
            <p className="text-black/70">Shure SM58 Dynamic</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">STAGE AMP</p>
            <p className="text-black/70">Marshall JCM900</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">CAMERA</p>
            <p className="text-black/70">Smartphone / Issta Setup</p>
          </div>
        </div>
      ),
      photo: 'img/kita/gear.jpg',
      caption: 'STAGE RIG',
      seat: '03C',
    },
    {
      ...
      content: (
        <div className="space-y-2 text-xs font-mono text-black">
          <p className="text-[10px] text-black/60 font-bold uppercase">// KESSOKU BAND INQUIRIES & ISSTA</p>
          <div className="space-y-1.5 border-l-2 border-[#C82329] pl-3">
            <div>
            ...
            <div>
              <span className="font-bold uppercase text-black/50 text-[9px] block">AFFILIATION / VENUE</span>
              <span className="text-black font-bold">Shuuka High & Livehouse STARRY</span>
            </div>
          </div>
        </div>
      ),
      photo: 'img/kita/contact.jpg',
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-50 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(105deg, transparent 30%, rgba(255,241,209,0.45) 42%, rgba(255,250,235,0.85) 50%, rgba(255,241,209,0.45) 58%, transparent 70%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(255,252,240,0.8) 0%, rgba(255,244,214,0.3) 40%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
      </div>
                  ...
                  <div>
                    <div className="flex justify-between items-start border-b-2 border-black pb-2 mb-3">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="bg-[#C82329] text-white text-[9px] font-black px-1.5 py-0.5 uppercase tracking-wider">
                          PASS NO. 0{idx + 1}
                        </span>
                  ...
                  <div className="pt-2 border-t border-dashed border-black/40 flex justify-between items-end text-[8px] text-black/60 font-bold uppercase">
                    ...
                    <div className="w-16 h-5 overflow-hidden opacity-80">
                      <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                        <pattern id={`fine-barcode-${idx}`} width="100%" height="10" patternUnits="userSpaceOnUse">
                        ...
                        <rect width="100%" height="100%" fill={`url(#fine-barcode-${idx})`} />
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="w-full h-[200px] bg-white border-2 border-black p-1 flex flex-col justify-between shadow-xs">
                    ...
                    <div className="text-center pt-0.5">
                      ...
                      <p className="text-[7.5px] font-extrabold text-[#E07A5F] tracking-widest mt-0.5">
                        IKUYO KITA
                      </p>
                    </div>
                  </div>
        ...
        <div className="absolute -inset-40 pointer-events-none z-50 mix-blend-screen opacity-40">
          {Array.from({ length: 14 }).map((_, i) => {
            ...
            return (
              <div
                key={i}
                className="absolute rounded-full bg-[#FFF6E0]"
        ...
        >
          ...
          <div className="w-[325px] p-5 flex items-stretch justify-between relative z-10">
            <div className="relative border-[4px] border-black p-2 pr-3 flex flex-col justify-between w-[185px] bg-[#fff] shadow-xs">
              <span
                className="absolute top-7 left-1 text-[#E07A5F] font-black text-xl tracking-tighter z-20 -rotate-6 whitespace-nowrap"
                style={{
                  textShadow:
