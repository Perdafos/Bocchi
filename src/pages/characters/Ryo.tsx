...
const Ryo = ({ onBack }: RyoProps) => {
      ...
      content: (
        <div className="space-y-2.5 text-xs leading-relaxed text-black font-mono">
          <p className="font-semibold">
            Yo. I’m Ryo Yamada—though if you want to call me something, make sure it’s <span className="bg-[#3b82f6] text-white px-1">Ryo-senpai!</span>
          </p>
          <p className="text-black/80">
            I’m the bassist and composer for Kessoku Band. I usually handle our musical direction, though I occasionally get distracted looking for weird plants to eat when I'm low on budget. Music is about self-expression, not following trends. But hey, if you want to buy me dinner, I won't say no.
          </p>
        </div>
      ),
      photo: 'img/ryo/aboutme.jpg',
      caption: 'BASSIST VIBES',
      seat: '02R',
    },
    {
      id: 'funfact',
      ...
      content: (
        <ul className="space-y-2 text-xs font-mono text-black list-disc list-inside">
          <li>Constantly borrows money from Nijika and others with vague promises of repayment.</li>
          <li>Loves obscure indie music and prides herself on being completely unique.</li>
          <li>Plays a customized Fender Precision Bass that she cares for deeply.</li>
          <li>Has a cool, detached aura but deeply treasures Kessoku Band.</li>
        </ul>
      ),
      photo: 'img/ryo/funfact.jpg',
      caption: 'COOL BASSIST',
      seat: '02B',
    },
    {
      id: 'equipment',
      ...
      content: (
        <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-black">
          <div className="bg-black/5 p-2 border border-black/25">
            ...
            <p className="text-black/70">Fender Precision Bass</p>
          </div>
          <div className="bg-[#121212]/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">AMPLIFIER</p>
            <p className="text-black/70">Ampeg SVT-CL Stack</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">EFFECTS</p>
            <p className="text-black/70">Custom Bass Overdrive</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">NOTEBOOK</p>
            <p className="text-black/70">Songwriting & Lyrics</p>
          </div>
        </div>
      ),
      photo: 'img/ryo/gear.jpg',
      caption: 'STAGE RIG',
      seat: '02C',
    },
    {
      ...
      content: (
        <div className="space-y-2 text-xs font-mono text-black">
          <p className="text-[10px] text-black/60 font-bold uppercase">// BAND INQUIRIES & LOAN REQUESTS</p>
          <div className="space-y-1.5 border-l-2 border-[#3b82f6] pl-3">
            <div>
              <span className="font-bold uppercase text-black/50 text-[9px] block">LOCATION</span>
              <span className="text-black font-bold">Shimokitazawa, Tokyo, JP</span>
            </div>
            <div>
              <span className="font-bold uppercase text-black/50 text-[9px] block">AFFILIATION</span>
              <span className="text-black font-bold">Kessoku Band / Livehouse STARRY</span>
            </div>
          </div>
        </div>
      ),
      photo: 'img/ryo/contactme.jpg',
      caption: 'STARRY VENUE',
      seat: '02D',
    },
  ];
  ...
  const ryoImgSrc = 'img/ryo/photocard.png';
    ...
    >
            ...
            >
              <h1 className="text-7xl font-black tracking-tighter uppercase leading-none flex gap-2 whitespace-nowrap">
                {wordRepeats.map((_, wordIdx) => {
                  const isBlue = (colIdx + wordIdx) % 2 === 0;
                  const word = (wordIdx + (isOddCol ? 1 : 0)) % 2 === 0 ? 'KESSOKU' : 'BAND';
                  return (
                    <span key={wordIdx} className={isBlue ? 'text-[#1e3a8a]' : 'text-[#808080]'}>
                      {word}
                    </span>
                  );
                })}
      ...
      <div className="absolute inset-0 pointer-events-none z-50 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(105deg, transparent 30%, rgba(191,219,254,0.45) 42%, rgba(239,246,255,0.85) 50%, rgba(191,219,254,0.45) 58%, transparent 70%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(239,246,255,0.8) 0%, rgba(191,219,254,0.3) 40%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
      </div>
      ...
      <div className="relative z-60 h-full flex flex-col justify-between p-8 text-white font-medium text-sm tracking-tight pointer-events-none">
        ...
        <div className="w-full flex justify-between items-end">
          ...
          <button
            onClick={onBack}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#3b82f6] text-white font-mono font-bold text-xs border-2 border-white shadow-[3px_3px_0px_#fff] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_#fff] transition-all cursor-pointer uppercase pointer-events-auto"
          >
                  ...
                  <div>
                    <div className="flex justify-between items-start border-b-2 border-black pb-2 mb-3">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="bg-[#3b82f6] text-white text-[9px] font-black px-1.5 py-0.5 uppercase tracking-wider">
                          PASS NO. 0{idx + 1}
                        </span>
                  ...
                  <div className="pt-2 border-t border-dashed border-black/40 flex justify-between items-end text-[8px] text-black/60 font-bold uppercase">
                    ...
                    <div className="w-16 h-5 overflow-hidden opacity-80">
                      <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                        <pattern id={`fine-barcode-ryo-${idx}`} width="100%" height="10" patternUnits="userSpaceOnUse">
                        ...
                        <rect width="100%" height="100%" fill={`url(#fine-barcode-ryo-${idx})`} />
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="w-full h-[200px] bg-white border-2 border-black p-1 flex flex-col justify-between shadow-xs">
                    ...
                    <div className="text-center pt-0.5">
                      ...
                      <p className="text-[7.5px] font-extrabold text-[#3b82f6] tracking-widest mt-0.5">
                        RYO YAMADA
                      </p>
                    </div>
                  </div>
      ...
      <div className="absolute top-100 left-100 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[650px]">
          ...
          >
            <div className="flex flex-col justify-between items-start border-t pt-2 border-black/20 w-full">
              <div className="text-[9px] font-bold tracking-tighter">
                ...
                <p className="text-[11px]">RYO YAMADA</p>
              </div>
              <div className="text-[9px] font-bold tracking-tighter">
              ...
              <div className="w-8 h-24 bg-transparent overflow-hidden">
                <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                  <pattern id="fine-barcode-horizontal-ryo" width="100%" height="8" patternUnits="userSpaceOnUse">
                  ...
                  <rect width="100%" height="100%" fill="url(#fine-barcode-horizontal-ryo)" />
                </svg>
              </div>
            </div>
        ...
        {/* 3. Photocard */}
        <Photocard imgSrc={ryoImgSrc} photoScale={1}/>
        ...
        >
          ...
          <div className="w-[325px] p-5 flex items-stretch justify-between relative z-10">
            <div className="relative border-[4px] border-black p-2 pr-3 flex flex-col justify-between w-[185px] bg-[#fff] shadow-xs">
              <span
                className="absolute top-7 left-1 text-[#3b82f6] font-black text-xl tracking-tighter z-20 -rotate-6 whitespace-nowrap"
                style={{
                  textShadow:
