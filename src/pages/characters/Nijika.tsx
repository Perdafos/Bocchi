...
interface NijikaProps {
  onBack?: () => void;
}

const Nijika = ({ onBack }: NijikaProps) => {
      ...
      content: (
        <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-black">
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">DRUM KIT</p>
            <p className="text-black/70">Tama Starclassic Custom</p>
          </div>
          <div className="bg-[#121212]/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">CYMBALS</p>
            <p className="text-black/70">Zildjian K Custom Series</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">DRUMSTICKS</p>
            <p className="text-black/70">Vic Firth 5A Wood Tip</p>
          </div>
          <div className="bg-black/5 p-2 border border-black/25">
            <p className="font-bold text-black uppercase">VENUE</p>
            <p className="text-black/70">Livehouse STARRY</p>
          </div>
        </div>
      ),
      photo: 'img/nijika/gear.jpg',
      caption: 'STAGE RIG',
      seat: '03C',
    },
    {
        ...
        <div className="space-y-2 text-xs font-mono text-black">
          ...
          <div className="space-y-1.5 border-l-2 border-[#eab308] pl-3">
            ...
            <div>
              ...
              <span className="text-black font-bold">Kessoku Band / STARRY</span>
            </div>
          </div>
        </div>
      ),
      photo: 'img/nijika/contactme.jpg',
  ...
  const nijikaImgSrc = 'img/nijika/photocard.png';
    ...
    >
            ...
            >
              <h1 className="text-7xl font-black tracking-tighter uppercase leading-none flex gap-2 whitespace-nowrap">
                {wordRepeats.map((_, wordIdx) => {
                  const isYellow = (colIdx + wordIdx) % 2 === 0;
                  const word = (wordIdx + (isOddCol ? 1 : 0)) % 2 === 0 ? 'KESSOKU' : 'BAND';
                  return (
                    <span key={wordIdx} className={isYellow ? 'text-[#ca8a04]' : 'text-[#808080]'}>
                      {word}
                    </span>
                  );
                })}
      ...
      <div className="absolute inset-0 pointer-events-none z-50 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(105deg, transparent 30%, rgba(254,240,138,0.45) 42%, rgba(254,252,232,0.85) 50%, rgba(254,240,138,0.45) 58%, transparent 70%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(254,252,232,0.8) 0%, rgba(254,240,138,0.3) 40%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
      </div>
      ...
      <div className="relative z-60 h-full flex flex-col justify-between p-8 text-white font-medium text-sm tracking-tight pointer-events-none">
        ...
        <div className="w-full flex justify-between items-end">
          ...
          <button
            onClick={onBack}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#eab308] text-black font-mono font-bold text-xs border-2 border-white shadow-[3px_3px_0px_#fff] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_#fff] transition-all cursor-pointer uppercase pointer-events-auto"
          >
                  ...
                  <div>
                    <div className="flex justify-between items-start border-b-2 border-black pb-2 mb-3">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="bg-[#eab308] text-black text-[9px] font-black px-1.5 py-0.5 uppercase tracking-wider">
                          PASS NO. 0{idx + 1}
                        </span>
                  ...
                  <div className="pt-2 border-t border-dashed border-black/40 flex justify-between items-end text-[8px] text-black/60 font-bold uppercase">
                    ...
                    <div className="w-16 h-5 overflow-hidden opacity-80">
                      <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                        <pattern id={`fine-barcode-nijika-${idx}`} width="100%" height="10" patternUnits="userSpaceOnUse">
                        ...
                        <rect width="100%" height="100%" fill={`url(#fine-barcode-nijika-${idx})`} />
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="w-full h-[200px] bg-white border-2 border-black p-1 flex flex-col justify-between shadow-xs">
                    ...
                    <div className="text-center pt-0.5">
                      ...
                      <p className="text-[7.5px] font-extrabold text-[#ca8a04] tracking-widest mt-0.5">
                        NIJIKA IJICHI
                      </p>
                    </div>
                  </div>
        ...
        <div className="absolute -inset-40 pointer-events-none z-50 mix-blend-screen opacity-40">
          {Array.from({ length: 14 }).map((_, i) => {
            ...
            return (
              <div
                key={i}
                className="absolute rounded-full bg-[#FEF08A]"
          ...
          >
            <div className="flex flex-col justify-between items-start border-t pt-2 border-black/20 w-full">
              <div className="text-[9px] font-bold tracking-tighter">
                ...
                <p className="text-[11px]">NIJIKA IJICHI</p>
              </div>
              <div className="text-[9px] font-bold tracking-tighter">
              ...
              <div className="w-8 h-24 bg-transparent overflow-hidden">
                <svg className="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                  <pattern id="fine-barcode-horizontal-nijika" width="100%" height="8" patternUnits="userSpaceOnUse">
                  ...
                  <rect width="100%" height="100%" fill="url(#fine-barcode-horizontal-nijika)" />
                </svg>
              </div>
            </div>
        ...
        >
          ...
          <div className="w-[325px] p-5 flex items-stretch justify-between relative z-10">
            <div className="relative border-[4px] border-black p-2 pr-3 flex flex-col justify-between w-[185px] bg-[#fff] shadow-xs">
              <span
                className="absolute top-7 left-1 text-[#eab308] font-black text-xl tracking-tighter z-20 -rotate-6 whitespace-nowrap"
                style={{
                  textShadow:
